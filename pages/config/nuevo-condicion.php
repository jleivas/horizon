      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Condicion Correctiva</h4>
                  <p class="card-description">
                    Formulario para agregar un nueva condición correctiva
                  </p>
                  <form  action="addCondicion.php"  method="post">
                  ...
                  <form action="condiciones"
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'condiciones'; 
