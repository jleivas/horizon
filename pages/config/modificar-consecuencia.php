      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Consecuencia inmediata</h4>
                  <p class="card-description">
                    Formulario para modificar una consecuencia inmediata
                  </p>
                  <form  action="updateConsecuencia"  method="post">
                    <div class="form-group">
                      <input style="visibility:hidden" type="text" class="form-control" name="id" id="id" value="<?php echo $load->getId();?>" required>
                  ...
                  <form action="consecuencias"
                            ...
                            id="update"
                            name="update" 
                            onclick= "document.form1.action = 'consecuencias'; 
