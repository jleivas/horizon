    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Condiciones Correctivas</h4>
                  
                  <p class="card-description">
                  <div class="form-group">
                    Crear nueva condición correctiva
                    <div class="row">
                        <div class="col-md-2">
                      <form action="nuevo-condicion"
                            name="form1"
                            id="form1"
                            method="post"> 
                            <input type="button" 
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'nuevo-condicion'; 
                          ...
                          <td>
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="modificar-condicion?id=<?php echo $fila['cn_id'];?>">
                                  <i class="fa fa-reply fa-fw"></i>Modificar</a>
                                <a class="dropdown-item" href="eliminar-condicion?id=<?php echo $fila['cn_id'];?>">
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="eliminar-condicion?id=<?php echo $fila['cn_id'];?>&st=1">
