      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Causa o vector</h4>
                  <p class="card-description">
                    Formulario para agregar una nueva causa o vector
                  </p>
                  <form  action="addCausa"  method="post">
                  ...
                  <form action="causas"
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'causas'; 
