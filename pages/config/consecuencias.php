...
if (!isset($rootDir)){
  $rootDir = $_SERVER['DOCUMENT_ROOT']."/horizon";
    ...
    $datos1=ConsecuenciaDao::sqlTodo();
} 
function buildPath(){
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Consecuencias inmediatas registradas en el sistema</h4>
                  
                  <p class="card-description">
                  <div class="form-group">
                    Crear nueva consecuencia inmediata
                    <div class="row">
                        <div class="col-md-2">
                      <form action="nueva-consecuencia"
                            name="form1"
                            id="form1"
                            method="post"> 
                            <input type="button" 
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'nueva-consecuencia'; 
                          ...
                          <td>
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="modificar-consecuencia?id=<?php echo $fila['re_id'];?>">
                                  <i class="fa fa-reply fa-fw"></i>Modificar</a>
                                <a class="dropdown-item" href="eliminar-consecuencia?id=<?php echo $fila['re_id'];?>">
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="eliminar-consecuencia?id=<?php echo $fila['re_id'];?>&st=1">
