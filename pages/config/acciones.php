    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Acciones correctivas registradas en el sistema</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <form action="nuevo-accion"
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'nuevo-accion'; 
                          ...
                          <td>
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="modificar-accion?id=<?php echo $fila['ac_id'];?>">
                                  <i class="fa fa-reply fa-fw"></i>Modificar</a>
                                <a class="dropdown-item" href="eliminar-accion?id=<?php echo $fila['ac_id'];?>">
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="eliminar-accion?id=<?php echo $fila['ac_id'];?>&st=1">
