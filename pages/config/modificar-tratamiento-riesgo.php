      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tratamiento de riesgo</h4>
                  <p class="card-description">
                    Formulario para modificar un nuevo tratamiento de riesgo
                  </p>
                  <form  action="updateTratamientoRiesgo"  method="post">
                  ...
                  <div class="form-group">
                  <form action="tratamiento-riesgo"
                            name="form1"
                            id="form1"
                            method="post"> 
                            <input type="button" 
                            ...
                            id="update"
                            name="update" 
                            onclick= "document.form1.action = 'tratamiento-riesgo'; 
