    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Responsables de Acciones y Condiciones Correctivas</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <form action="nuevo-autor"
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'nuevo-autor'; 
                          ...
                          <td>
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="modificar-autor?id=<?php echo $fila['au_id'];?>">
                                  <i class="fa fa-reply fa-fw"></i>Modificar</a>
                                <a class="dropdown-item" href="eliminar-autor?id=<?php echo $fila['au_id'];?>">
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="eliminar-autor?id=<?php echo $fila['au_id'];?>&st=1">
