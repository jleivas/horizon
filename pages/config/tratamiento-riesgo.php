...
if (!isset($rootDir)){
  $rootDir = $_SERVER['DOCUMENT_ROOT']."/horizon";
    ...
    $datos1=TratamientoRiesgoDao::sqlTodo();
}
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tratamientos de riesgo registrados en el sistema</h4>
                  
                  <p class="card-description">
                  <div class="form-group">
                    Crear nuevo tratamiento de riesgo
                    <div class="row">
                        <div class="col-md-2">
                      <form action="nuevo-tratamiento-riesgo"
                            name="form1"
                            id="form1"
                            method="post"> 
                            <input type="button" 
                            ...
                            id="nuevo"
                            name="nuevo" 
                            onclick= "document.form1.action = 'nuevo-tratamiento-riesgo'; 
                          ...
                          <td>
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="modificar-tratamiento-riesgo?id=<?php echo $fila['tr_id'];?>">
                                  <i class="fa fa-reply fa-fw"></i>Modificar</a>
                                <a class="dropdown-item" href="eliminar-tratamiento-riesgo?id=<?php echo $fila['tr_id'];?>">
                            ...
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="eliminar-tratamiento-riesgo?id=<?php echo $fila['tr_id'];?>&st=1">
